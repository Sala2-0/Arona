...
internal class ShipAutocomplete(IApiClient apiClient, IDatabaseRepository repository) : IAutocompleteProvider<AutocompleteInteractionContext>
{
        ...
        AutocompleteInteractionContext context)
    {
        ...
        var res = await apiClient.HttpClient.GetAsync("https://api.wows-numbers.com/personal/rating/expected/json/");
